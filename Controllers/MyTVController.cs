    ...
    public class MyTVController : BaseController
    {
        ...
        public JsonResult XuLyTichHop(Common.DefaultObj obj)
        {
            ...
            try
            {
                ...
                qry = $@"UPDATE {Common.Objects.TYPE_HD.HD_MYTV} SET TONG=PAYTV_FEE+SUB_FEE,GOICUOCID=0 WHERE GOICUOCID>0 AND (PAYTV_FEE+SUB_FEE)<TONG AND TYPE_BILL=8 AND FORMAT(NGAY_SD,'MM/yyyy')='{obj.month_year_time}' AND FORMAT(TIME_BILL,'MM/yyyy')='{obj.month_year_time}'";
